module "network" {
  source                = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/network"
...
module "external_services" {
  source                     = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/ext-services"
...
module "key_pair" {
  source          = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/key-pair"
...
module "tfe_installation_assets" {
  source                   = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/installation-assets"
...
module "tfe_instance" {
  source = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/asg-ec2-instance"
...
module "tfe_dns" {
  ...
  source           = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/dns"
...
module "ssh_hop" {
  source              = "git::https://github.com/slavrd/tfev4-aws-online-install//modules/ssh-hop"
